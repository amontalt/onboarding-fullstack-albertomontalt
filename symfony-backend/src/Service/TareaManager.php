...
class TareaManager
{
    ...
    public function crear(array $payload, Usuario $usuario): Tarea
    {
        ...
        $fechaCreacion = new \DateTimeImmutable(); // Capturamos la fecha de creación primero
        ...
        // --- SOLUCIÓN MINI RETO 1: Validación de fecha ---
    ...
    /**
     * Devuelve únicamente las tareas en estado 'pendiente' para un usuario.
     */
